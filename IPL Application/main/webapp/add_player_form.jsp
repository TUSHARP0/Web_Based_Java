...
<jsp:useBean id="ipl" class="bean.IPLBean" scope="application" />
<jsp:useBean id="data" class="bean.PlayerBean" scope="application" />
		...
		<table style="background-color: lightgrey; margin: auto">
			<tr>
				...
				<td><select name="myTeam">
						<c:forEach var="t" items="${applicationScope.ipl.fetchAllDetails()}">
						<option value="${t.id}">${t.abb}</option>
						</c:forEach>
				</select></td>
			</tr>
			<tr>
